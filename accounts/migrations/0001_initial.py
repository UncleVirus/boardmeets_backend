    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org_reference_key', models.CharField(blank=True, max_length=250, null=True)),
                ('twofa_status', models.BooleanField(default=False)),
                ('org_permission', models.CharField(blank=True, max_length=40, null=True)),
                ('profile_photo', models.CharField(blank=True, max_length=20000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('verification_code', models.CharField(max_length=6, verbose_name='verification_code')),
                ('validated', models.BooleanField(default=False)),
                ('expiry_time', models.CharField(blank=True, max_length=100)),
        ...
        migrations.AddField(
            model_name='user',
            name='org_groups',
            field=models.ManyToManyField(blank=True, related_name='org_group', to='accounts.OrgGroup'),
        ),
        migrations.AddField(
            model_name='user',
